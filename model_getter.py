...
def get_model(dataset, framework='pytorch'):
    if dataset == 'cifar10':
        ...
        #return resnet32(framework, num_classes = 10, input_shape=(32,32,3), dataset=dataset)
    elif dataset == 'cifar100':
        return model_cifar100(framework)
        #return resnet32(framework, num_classes = 100, input_shape=(32,32,3), dataset=dataset)
...
#     elif framework == 'tensorflow':
#         return None
def resnet32(framework, num_classes, input_shape, dataset):
    import os
    if framework == 'pytorch':
        import torch
        from torch import nn
        ...
        # except:
            #net = resnet34(pretrained=False)
        #net = ResNet32(dataset == 'cifar100' and num_classes)
            # model = ResNet32(args.dataset == 'cifar10' and 10 or 100)
        net = WideResNet(28, dataset == 'cifar100' and num_classes,
                       10, dropRate=0)
